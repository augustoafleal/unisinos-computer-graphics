...
int main()
{
    ...
    Shader shader("../20250531_atividadeVivencial/shaders/vertex_shader.glsl", "../20250531_atividadeVivencial/shaders/fragment_shader.glsl");
    Geometry suz1 = setupGeometry("../20250531_atividadeVivencial/models/suzanne_painted/suzanne_painted.obj");
    suz1.position = glm::vec3(-0.5f, 0.0f, 0.0f);

    //Geometry suz2 = setupGeometry("../20250531_atividadeVivencial/models/suzanne_painted/suzanne_painted.obj");
    //suz2.position = glm::vec3(0.5f, 0.0f, 0.0f);
    ...
    shader.setVec3("lightColor", 1.1f, 1.1f, 1.1f);
    ...
    GLuint backgroundTexture = setupBackgroundQuad(backgroundVAO, backgroundVBO, "../20250531_atividadeVivencial/textures/leaves.png");
    Shader backgroundShader("../20250531_atividadeVivencial/shaders/vertex_background.glsl", "../20250531_atividadeVivencial/shaders/fragment_background.glsl");
