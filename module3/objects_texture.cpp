...
int main()
{
    ...
    Shader shader("../module3/shaders/vertex_shader.glsl", "../module3/shaders/fragment_shader.glsl");
    Geometry geom = setupGeometry("../module3/models/suzanne_painted/suzanne_painted.obj");
