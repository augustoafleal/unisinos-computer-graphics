...
//string textureFile = loadMTL(mtlPath, geom.ka, geom.kd, geom.ks, geom.ke, geom.shininess);
...
string loadMTL(const string& path, glm::vec3& ka, glm::vec3& kd, glm::vec3& ks, glm::vec3& ke, float& shininess);
...
int main()
{
    ...
    Shader shader("../tests/shaders/vertex_shader.glsl", "../tests/shaders/fragment_shader.glsl");
    Geometry suz1 = setupGeometry("../tests/models/suzanne/suzanne.obj");
    suz1.position = glm::vec3(-0.6f, 0.0f, 0.0f);

    Geometry suz2 = setupGeometry("../tests/models/suzanne/suzanne.obj");
    suz2.position = glm::vec3(0.6f, 0.0f, 0.0f);

    std::vector<Geometry> sceneObjects = {  suz1, suz2 };
...
Geometry setupGeometry(const char* filepath)
{
    ...
    geom.ka = glm::vec3(0.0f);
    geom.kd = glm::vec3(0.0f);
    geom.ks = glm::vec3(0.0f);
    geom.ke = glm::vec3(0.0f);
    geom.shininess = 32.0f;
