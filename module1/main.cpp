 ...
 * Última atualizaçãoo em 12/05/2023
 *
 */
...
// Prototipo da fun��o de callback de teclado
...
//Codifo fonte do Fragment Shader (em GLSL): ainda hardcoded
...
int main()
{
	...
	//Muita atencao aqui: alguns ambientes nao aceitam essas configuraoes
	//Voce deve adaptar para a versao do OpenGL suportada por sua placa
	//Sugestao: comente essas linhas de cadigo para desobrir a versao e
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ola 3D -- Augusto!", nullptr, nullptr);
...
// Funcao de callback de teclado - so pode ter uma instancia (deve ser estatica se
...
// O codigo fonte do vertex e fragment shader est� nos arrays vertexShaderSource e
...
int setupGeometry()
{
	...
	// Observe que isso e permitido, a chamada para glVertexAttribPointer registrou o VBO como o objeto de buffer de v�rtice
