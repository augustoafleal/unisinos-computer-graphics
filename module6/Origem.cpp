...
#include "HelloCurves/Bezier.h"
#include "HelloCurves/CatmullRom.h"
#include "HelloCurves/Hermite.h"
...
int main()
{
    ...
    Shader shader = Shader("../module6/shaders/vertex_curves.glsl", "../module6/shaders/fragment_curves.glsl");
